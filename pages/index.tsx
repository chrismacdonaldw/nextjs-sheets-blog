      ...
      {listed ? (
        <div>
          ...
          <p className="text-m text-center">
            Utilizing Next.JS, Google Sheets, and Tailwind
          </p>
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          ...
          <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
            <div className="mb-4">
              <a
                aria-label="Article"
                className="text-red-500 inline-block max-w-lg font-sans text-3xl font-extrabold leading-none tracking-tight text-black transition-colors duration-200 hover:text-deep-purple-accent-700 sm:text-4xl"
              >
                {rows[0].title}
              </a>
            </div>
          ...
          <div className="mb-10 sm:text-center">
            {rows[0].body.split("\n").map((paragraph: string) => (
              <p
                ...
                className={
                  (rows[0].success ? "float-left text-left" : "") +
                  " indent-md whitespace-pre-wrap transition-colors duration-200 hover:text-deep-purple-accent-700"
                }
              >
                {paragraph}
              </p>
